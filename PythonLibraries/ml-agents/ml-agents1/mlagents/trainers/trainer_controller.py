...
class TrainerController(object):
    print("Train  Controller function call")
    def __init__(self,
                 model_path: str,
                 summaries_dir: str,
                 run_id: str,
    ...
    def initialize_trainers(self, trainer_config: Dict[str, Dict[str, str]]):
        ...
        for brain_name in self.external_brains:
            if trainer_parameters_dict[brain_name]['trainer'] == 'offline_bc':
                ...
                print("Parameters brain name for PP////////O trainer in trainer_controller")
    ...
    def start_learning(self, env: BaseUnityEnvironment, trainer_config):
        ...
        print("In trainer Controller learning will be start")
        # for each curriculum.
        if self.meta_curriculum is not None:
