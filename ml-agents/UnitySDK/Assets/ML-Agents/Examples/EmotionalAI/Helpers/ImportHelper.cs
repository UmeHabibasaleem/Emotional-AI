...
namespace NeuralNetwork.Helpers
{
	...
	{
		public static NetworkModels.Network ImportNetwork()
		{
            Debug.Log("I am in real function");
			var dn = GetHelperNetwork();
			if (dn == null) return null;

			var network = new NetworkModels.Network();
		...
		{
            string path = @"C:\Users\Abubakar\Documents\GitHub\Emotional-AI\ml-agents\UnitySDK\Assets\ML-Agents\Examples\EmotionalAI\DataExamples\FiveHundredDataNetwork.txt";
			try
			{
